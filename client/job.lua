...
function TakeOutVehicle(vehicleInfo, price)
    TriggerServerEvent('qb-policejob:server:buyVehicle',vehicleInfo, price)
end
...
-------
RegisterNetEvent('qb-policejob:client:buyVehicle', function(vehicle, plate)
