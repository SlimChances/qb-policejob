...
-----
RegisterNetEvent('qb-policejob:server:buyVehicle', function(vehicle, price)
    local src = source
    ...
    if cash > vehiclePrice then
        ...
        TriggerClientEvent('qb-policejob:client:buyVehicle', src, vehicle, plate)
        pData.Functions.RemoveMoney('cash', vehiclePrice, 'PD-Vehicle_Bought')
    elseif bank > vehiclePrice then
        ...
        TriggerClientEvent('QBCore:Notify', src, 'Congratulations on your purchase!', 'success')
        TriggerClientEvent('qb-policejob:client:buyVehicle', src, vehicle, plate)
        pData.Functions.RemoveMoney('bank', vehiclePrice, 'PD-Vehicle_Bought')
    else
